    ...
    <div className="min-h-screen bg-stone-100 font-sans">
      <div className="max-w-md mx-auto pb-10">
        <header className="sticky top-0 bg-white border-b border-stone-200 px-4 py-3 flex items-center gap-3 z-10">
          ...
          <h1 className="font-semibold text-stone-800">Site Statistics</h1>
        </header>
        ...
        <div className="p-4 space-y-6">
          ...
          <div>
            ...
            <div className="bg-white rounded-xl border border-stone-200 p-4 flex flex-wrap gap-2">
              {Object.entries(byType).length === 0 && <p className="text-sm text-stone-400">No data yet</p>}
          ...
          <div>
            ...
            <div className="bg-white rounded-xl border border-stone-200 p-4 space-y-2.5">
              {trackingSorted.length === 0 && <p className="text-sm text-stone-400">No data yet</p>}
          ...
          <div>
            ...
            <div className="bg-white rounded-xl border border-stone-200 p-4 space-y-2.5">
              {userSorted.length === 0 && <p className="text-sm text-stone-400">No data yet</p>}
              {userSorted.map(([name, count]) => (
                <div key={name}>
                  ...
                  <div className="h-2 rounded-full bg-stone-100 overflow-hidden">
                    <div className="h-full rounded-full bg-stone-500" style={{ width: `${(count / maxUser) * 100}%` }} />
                  </div>
                </div>
              ))}
            </div>
